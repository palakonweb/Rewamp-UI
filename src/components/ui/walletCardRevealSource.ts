...
- Behind the wallet: A tiered stack of 3 branded payment cards:
...
- Front pouch: A tactile matte black leather wallet (#121212) with fine perimeter dashed stitching, a subtle top concave scoop opening, and a center display showing "Total Balance".
  ...
  - On clicking the eye button:
    ...
    - Card balances smoothly animate from "******" into real dollar amounts ($32,495, $45,654, $345,865).
      ...
      <div className="relative w-[320px] sm:w-[335px] pt-14 pb-4 flex flex-col items-center">
        ...
        >
          ...
          <div className="flex flex-col items-center justify-center text-center my-auto">
            ...
            <span className="text-[13px] font-medium text-white/45 mt-2">
              Total Balance
            </span>
          </div>

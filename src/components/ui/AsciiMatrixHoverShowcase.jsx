    ...
    <div className="w-full flex flex-col gap-6 max-w-4xl mx-auto">
      ...
      >
        ...
        <div className="relative z-20 flex flex-col items-center pointer-events-none">
            <h2 className="text-4xl sm:text-5xl font-black tracking-tighter text-white mb-2 drop-shadow-lg">
                <span className="text-emerald-400">{'// '}</span>MATRIX_GHOST
            </h2>
            <div className="px-4 py-1.5 rounded bg-white/[0.03] backdrop-blur border border-white/10 text-white/50 font-mono text-[10px] tracking-widest uppercase">
                System Active
            </div>
        </div>

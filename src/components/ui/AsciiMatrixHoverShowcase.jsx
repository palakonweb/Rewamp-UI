  ...
  return (
    <div className="w-full h-full flex flex-col gap-6 max-w-4xl mx-auto">
      <div 
        ...
        className="relative w-full rounded-[24px] overflow-hidden border border-white/10 flex flex-col items-center justify-center flex-1 min-h-0 bg-[#020202] group select-none cursor-crosshair"
      >

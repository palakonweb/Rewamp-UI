...
export default function BentoDropMenuNavbarShowcase() {
    ...
    return (
        <div className="w-full flex flex-col gap-6 max-w-4xl mx-auto">
            ...
            <div className="w-full rounded-2xl bg-white dark:bg-[#111] border border-black/5 dark:border-white/10 p-5 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 shadow-sm z-0 relative">

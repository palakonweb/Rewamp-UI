    ...
    <div className="flex items-center gap-1.5">
      ...
      <div className="relative w-5 h-6">
        <svg viewBox="0 0 24 28" className="w-full h-full">
          <path
            d="M5 2h10c4 0 7 2.5 6 6.5-1 4-4 6.5-8 6.5H9l-2 11H2L5 2z"
            fill="#003087"
          />
          <path
            d="M8 7h10c3.5 0 6 2 5 5.5s-3.5 6.5-7.5 6.5H12l-1.5 8H6l3-20h-1z"
            fill="#0079C1"
            opacity="0.88"
          />
        </svg>
  ...
  const cards: CardData[] = [
    {
      ...
      balance: '$32,495',
      hiddenBalance: '******',
      bgColor: '#9B9EFF', // soft periwinkle
      textColor: '#FFFFFF',
      offsetYClosed: 0,
      offsetYOpen: -130,
    },
  ...
  return (
    <div className={`relative flex flex-col items-center justify-center p-6 sm:p-10 select-none ${className}`}>
      ...
      <div className="relative w-full max-w-[340px] pt-32 pb-4 flex flex-col items-center">
        ...
        {/* ── Front Pouch: Dark Moss Leather Wallet ── */}
        <div
        ...
        >
          ...
          <div
            aria-hidden="true"
            className="absolute -top-3 left-1/2 -translate-x-1/2 w-48 h-6 bg-transparent rounded-b-[100%] shadow-[inset_0_-2px_4px_rgba(0,0,0,0.3)]"
          />
          ...
          <div className="flex flex-col items-center justify-center text-center my-auto">
            ...
            <span className="text-[13px] font-medium text-emerald-100/50 mt-2 tracking-normal">
              Total Balance
            </span>
          </div>
